...
*/}}
{{- define "team-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "team-operator.resourceName" -}}
{{- $fullname := include "team-operator.fullname" .context }}
{{- $suffix := .suffix }}
