...
// WithIdentityFederation adds the given value to the IdentityFederation field in the declarative configuration
// and returns the receiver, so that objects can be build by chaining "With" function invocations.
// If called multiple times, values provided by each call will be appended to the IdentityFederation field.
func (b *PackageManagerConfigApplyConfiguration) WithIdentityFederation(values ...*PackageManagerIdentityFederationConfigApplyConfiguration) *PackageManagerConfigApplyConfiguration {
	for i := range values {
		if values[i] == nil {
			panic("nil value passed to WithIdentityFederation")
		}
		b.IdentityFederation = append(b.IdentityFederation, *values[i])
	}
	return b
}
...
func (b *PackageManagerConfigApplyConfiguration) WithAdditionalConfig(value string) *PackageManagerConfigApplyConfiguration {
