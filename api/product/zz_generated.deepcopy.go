...
func (in *DynamicLabelRule) DeepCopyInto(out *DynamicLabelRule) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DynamicLabelRule.
func (in *DynamicLabelRule) DeepCopy() *DynamicLabelRule {
	if in == nil {
		return nil
	}
	out := new(DynamicLabelRule)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PodConfig) DeepCopyInto(out *PodConfig) {
	*out = *in
	...
	if in.DynamicLabels != nil {
		...
		*out = make([]DynamicLabelRule, len(*in))
		copy(*out, *in)
	}
	if in.Volumes != nil {
